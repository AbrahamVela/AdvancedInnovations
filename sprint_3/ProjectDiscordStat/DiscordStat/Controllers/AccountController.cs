...
namespace DiscordStats.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ILogger<HomeController> logger, IDiscordService discord, IConfiguration config, IServerRepository serverRepository, IChannelRepository channelRepository, IPresenceRepository presenceRepository, IVoiceChannelRepository voiceChannelRepository, IDiscordUserAndUserWebSiteInfoRepository userRepository, IMessageInfoRepository messageInfoRepository)
        {
            _logger = logger;
            _discord = discord;
