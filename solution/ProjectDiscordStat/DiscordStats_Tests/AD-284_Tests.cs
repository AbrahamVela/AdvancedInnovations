...
namespace DiscordStats_Tests
{
    internal class AD284_Test
    {
        ...
        [Test]
        public async Task Check_Token_Should_Return_False()
        {
         CaptchaService _captchaService = new CaptchaService();
         var BadToken = await _captchaService.VerifyToken("asdf");
         Assert.IsFalse(BadToken); 
